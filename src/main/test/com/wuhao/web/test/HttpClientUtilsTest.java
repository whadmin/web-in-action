package com.wuhao.web.test;

import java.util.HashMap;
import java.util.Map;

import com.wuhao.web.httpClient.util.HttpClientResult;
import com.wuhao.web.httpClient.util.HttpClientUtils;
...
public class HttpClientUtilsTest {
    ...
    @Test
    public void testCompressEntityReqAndRep() throws Exception {
        ...
        HttpClientResult result = HttpClientUtils.doPost("http://localhost:8080/webinaction/compressEntityReqAndRep", headers, GzipUtils.compress(str));
    ...
    public void testPost() throws Exception {
        ...
        headers.put("User-Agent", "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36");
        HttpClientResult result = HttpClientUtils.doPost("http://127.0.0.1:8080/hello/post", headers, new HashMap<>());
        System.out.println(result);
    }
